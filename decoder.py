...
class Decoder(chainer.Chain):
    def __init__(self, config):
        ...
        super(Decoder, self).__init__(
            ...
            conv1_1 = L.Convolution2D(512, 512, 3,1,pad=0, initialW=initializer),
            bn1_1 = L.BatchNormalization(512, 1e-3),
            conv1_2 = L.Convolution2D(512, 512, 3,1,pad=0, initialW=initializer),
            bn1_2 = L.BatchNormalization(512, 1e-3),
            conv2_1 = L.Convolution2D(512, 512, 3,1,pad=0, initialW=initializer),
            bn2_1 = L.BatchNormalization(512, 1e-3),
            conv2_2 = L.Convolution2D(512, 512, 3,1,pad=0, initialW=initializer),
            bn2_2 = L.BatchNormalization(512, 1e-3),
            conv2_3 = L.Convolution2D(512, 512, 3,1,pad=0, initialW=initializer),
            bn2_3 = L.BatchNormalization(512, 1e-3),
            conv3_1 = L.Convolution2D(512, 256, 3,1,pad=0, initialW=initializer),
            bn3_1 = L.BatchNormalization(256, 1e-3),
            conv3_2 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn3_2 = L.BatchNormalization(256, 1e-3),
            conv3_3 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn3_3 = L.BatchNormalization(256, 1e-3),
            conv3_4 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn3_4 = L.BatchNormalization(256, 1e-3),
            conv4_1 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn4_1 = L.BatchNormalization(256, 1e-3),
            conv4_2 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn4_2 = L.BatchNormalization(256, 1e-3),
            conv4_3 = L.Convolution2D(256, 256, 3,1,pad=0, initialW=initializer),
            bn4_3 = L.BatchNormalization(256, 1e-3),
            conv5_1 = L.Convolution2D(256, 128, 3,1,pad=0, initialW=initializer),
            bn5_1 = L.BatchNormalization(128, 1e-3),
            conv5_2 = L.Convolution2D(128, 128, 3,1,pad=0, initialW=initializer),
            bn5_2 = L.BatchNormalization(128, 1e-3),
            conv5_3 = L.Convolution2D(128, 128, 3,1,pad=0, initialW=initializer),
            bn5_3 = L.BatchNormalization(128, 1e-3),
            conv6_1 = L.Convolution2D(128, 64, 3,1,pad=0,initialW=initializer),
            bn6_1 = L.BatchNormalization(64, 1e-3),
            conv6_2 = L.Convolution2D(64, 64, 3,1,pad=0, initialW=initializer),
            bn6_2 = L.BatchNormalization(64, 1e-3),
            conv6_3 = L.Convolution2D(64, 64, 3,1,pad=0, initialW=initializer),
            bn6_3 = L.BatchNormalization(64, 1e-3),
            conv7_1 = L.Convolution2D(64, 32, 3,1,pad=0, initialW=initializer),
            bn7_1 = L.BatchNormalization(32, 1e-3),
            conv7_2 = L.Convolution2D(32, 32, 3,1,pad=0, initialW=initializer),
            bn7_2 = L.BatchNormalization(32, 1e-3),
            conv7_3 = L.Convolution2D(32, 32, 3,1,pad=0, initialW=initializer),
    ...
    def __call__(self, x):
        x=self.deconv(x)
        x=pad_reflect.pad(x,(1,1),mode='reflect')
